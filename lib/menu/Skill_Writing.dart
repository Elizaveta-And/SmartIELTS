          ...
          child: Container(
            child: Column(
              children: [
                ...
                Container(
                  width: 350,
                  child: Text(writings[0]["task"], style: TextStyle(fontSize: 20)),
                ),
                Container(
                width: 360,child: Image.network(writings[0]["image"])),
                SizedBox(height: 10),
                Container(
                  width: 350,
                ...
                Container(
                  width: 350,
                  child: Text(writings[1]["task"], style: TextStyle(fontSize: 20)),
                ),
                SizedBox(height: 10),
                Container(
                  width: 350,
